...
const PopupContent = lazy(() => import("./popup/popupcontent")); // Lazy load the component
...
import CustomZoombuttons from "./assets/customZoomButtons";
import ZoomToCenterButton from "./assets/zoomTocentre";
