...
import { Search, Info, CreditCard, MapPin, BarChart, MessageCircle, X } from 'lucide-react';
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      {isOpen && (
        ...
        >
          <div 
            className="w-full max-w-5xl bg-white shadow-2xl rounded-2xl overflow-hidden flex flex-col max-h-[90vh] relative"
...
export default PostOfficeSchemesBotUI;