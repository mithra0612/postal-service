...
export default function PersonDashboard() {
  ...
  return (
    ...
    >
      ...
      <div className="p-6 h-fit mt-0 w-screen">
        <motion.h2
          variants={itemVariants}
                  ...
                  <div className="flex flex-col space-y-2">
                    <div className="bg-gray-100 p-3 rounded-lg">
                      <p className="text-md text-gray-600 leading-1">
                        Based on your {user.riskAppetite} risk appetite, we recommend investments
                        with moderate returns. For a {user.duration} investment
